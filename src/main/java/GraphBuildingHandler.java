...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private ArrayList<Node> tempWayNodes;
    private ArrayList<Edge> tempWayEdges;
    ...
    public GraphBuildingHandler(GraphDB g) {
        ...
        g.nodeList = new HashMap<>();
        g.adjNList = new HashMap<>();
    }
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            g.addNode(new Node(lon, lat, id));
            lastNodeID = id;

        } else if (qName.equals("way")) {
            /* We encountered a new <way...> tag. */
            activeState = "way";
            tempWayEdges = new ArrayList<>();
            ...
            tempWayNodes.add(n);
            if (tempWayEdges.size() == 0) {
                tempWayEdges.add(new Edge(n.id));
            } else {
                tempWayEdges.get(tempWayEdges.size() - 1).node2 = n.id;
                tempWayEdges.add(new Edge(n.id));
            }
            ...
            if (k.equals("maxspeed")) {
                ...
                for (Edge e : tempWayEdges) {
                    e.maxSpeed = Integer.parseInt(v.substring(0, v.length() - 4));
                }
            ...
            g.addNodeName(lastNodeID, attributes.getValue("k"));
        }
    }
...
//            System.out.println("Finishing a way...");
            if (correctType) {
                tempWayEdges.remove(tempWayEdges.size() - 1);
                g.addWay(tempWayNodes, tempWayEdges);
                correctType = false;
            }
        }
    }
